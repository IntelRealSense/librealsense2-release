...
The packages in the `librealsense2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --track jazzy --new-track librealsense2 --edit -d` on `Sun, 16 Jun 2024 17:17:26 -0000`
